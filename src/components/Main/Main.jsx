...
const Main = () => {
  ...
  return (
    <div className="images">
      {/* <div className="page-cover jquery-ripples" style={{ background: 'none 100% center no-repeat', objectFit: 'cover' }}>
        <canvas width={1903} height={912} style={{ position: 'absolute', inset: '0px', zIndex: -1 }}>
        </canvas>
        <canvas width={1372} height={887} style={{ position: 'absolute', inset: '0px', zIndex: -1 }} /></div> */}
          ...
          <div className="container landing-page">
            <div className="row mb-4 mt-2">
              ...
              {t("DRIPNetworkisthelatestprojectdevelopedby.1")}{" "}
                <a href="">{t("Forex_Shark.1")}</a>, <a href="">{t("BB.1")}</a> {t("andteam..1")}
              </div>
